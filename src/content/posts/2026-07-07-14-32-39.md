...
description: "EDU邮箱福利全览 "
sourceLink: https://linux.do/t/topic/304195
category: 教程
tags:
  - 教程
  - 邮箱
...
---
# **EDU邮箱福利介绍与注册时需要的文件和步骤**

---

### **我如果收集的不够全希望大佬们能给补充**

![:smile:](https://linux.do/images/emoji/twemoji/smile.png?v=15 ":smile:")

![:smile:](https://linux.do/images/emoji/twemoji/smile.png?v=15 ":smile:")

![:smile:](https://linux.do/images/emoji/twemoji/smile.png?v=15 ":smile:")

### **内容由互联网收集而来，如有变动麻烦各位热心佬友下方说明补充为其他佬友们指条明路（此贴会不断更新，但凡是佬友指出有新的Edu学生优惠都会在此贴补充发布并附上佬友的名字与主页表示感谢共同创作）**

---

### **1. GitHub 学生开发者包 (GitHub Student Developer Pack)**

**权益：**

- 免费使用多达 89 种开发工具，包括 Microsoft Azure、JetBrains、Heroku、GitHub Pro 等。
- 提供免费域名（如 Namecheap [提供的一年免费.me](http://提供的一年免费.me)域名）。
...
### **6. Google Workspace for Education (仅限国外教育机构)**
...
5. 群友[Judi_W](https://linux.do/u/judiw/summary)提供最新的最新资讯需要走支某宝验证edu可能不再适用 请网友自行测试
...
### **16. [iAsk.ai](http://iAsk.ai) 免费人工智能搜索引擎 (Ask™ AI)**
...
4. 进入邮箱确认后，[再重新回到iask.ai](http://再重新回到iask.ai)网站主页。
...
### **17. 阿里云学生计划(由[NorthSecond](https://linux.do/u/yangyf83/summary)佬友指点)**
...
### **21. 语雀(由[zd1737](https://linux.do/u/zd1737/summary)佬友指点)**
...
3. 填写edu邮箱（仅支持*******.[edu.cn](http://edu.cn)）发送认证邮件
...
### **21. Craft(由[zack](https://linux.do/u/rynoway/summary)佬友指点)**
...
### **22. Miro(由[AdamWang](https://linux.do/u/adamwang/summary)佬友指点)**
...
### **23. Sketch(由[AdamWang](https://linux.do/u/adamwang/summary)佬友指点)**
...
### **24. Raycast(由[AdamWang](https://linux.do/u/adamwang/summary)佬友指点)**
...
### **24. 扫描全能王(由[snail/boy](https://linux.do/u/snail-boy/summary)佬友指点)**
...
### **25. MATLAB (MathWorks) 学生版优惠(由[无名小卒](https://linux.do/u/wap1wep/summary)佬友指点)**
...
### **26. OriginLab 学生版优惠(由[AJAX](https://linux.do/u/AJAX/summary)佬友指点)**
...
### **27. [you.com](http://you.com) 教育版优惠(由[Zzeng](https://linux.do/u/Zzeng/summary)佬友指点)**
...
### **28. 网易云音乐 黑胶vip(由[NExT](https://linux.do/u/NExTo/summary)佬友指点)**
...
### **29. 百度网盘 vip(由[NExT](https://linux.do/u/NExTo/summary)佬友指点)**
...
### **30. Ansys Academic Program (Education Discount)(由[dujc98](https://linux.do/u/dujc98/summary)佬友指点)**
...
### **31.CST Studio Suite (Education Discount)(由[dujc98](https://linux.do/u/dujc98/summary)佬友指点)**
